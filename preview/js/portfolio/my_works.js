...
function buildGridPanel(entries) {
    const panel = document.createElement("div");
    panel.className = "my-work-panel my-work-grid-panel";
    ...
    styleSelectorButtons.forEach(button => {
        button.addEventListener("click", () => {
            ...
            const applyStyle = () => {
                ...
                [...myWorkContainer.children].forEach(child => {
            ...
            if (leavingLineView) {
                ...
                lines.forEach(line => line.classList.add("leaving"));
                lines[lines.length - 1].addEventListener("animationend", applyStyle, { once: true });
                return;
            }
