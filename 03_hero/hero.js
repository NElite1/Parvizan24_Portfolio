...
/* The dragon is out of the repo: dragon-embed.js is gitignored, #hero-dragon
   is commented out of index.html, so window.Dragon never exists and this
   whole block would no-op anyway. Line-commented (block comments do not nest)
   so it can come straight back when she does. */
